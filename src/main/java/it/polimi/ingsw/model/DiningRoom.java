    ...
    public void addPawn(ColorPawn colorPawn, Player player, Entrance entrance) {
        ...
        for(j = 0; j < 10; j++){
                 if(position[0][j] != 1){
                   ...
                   numGreen = j;
                   entrance.greenPawn--;
                     if(Game.isExpert && (position[0][2] == 1 || position[0][5] == 1 || position[0][9] == 1))
                         player.numCoin++;
                   break;
                 }
             }
        ...
        if(Objects.equals(colorPawn.toString(), Game.m.get(1)))
            for(j = 0; j < 10; j++){
                if(position[1][j] != 1){
                    ...
                    numRed = j;
                    entrance.redPawn--;
                    if(Game.isExpert && (position[1][2] == 1 || position[1][5] == 1 || position[1][9] == 1))
                        player.numCoin++;
                    break;
                }
            }
        ...
        if(Objects.equals(colorPawn.toString(), Game.m.get(2)))
            for(j = 0; j < 10; j++){
                if(position[2][j] != 1){
                    ...
                    numYellow = j;
                    entrance.yellowPawn--;
                    if(Game.isExpert && (position[2][2] == 1 || position[2][5] == 1 || position[2][9] == 1))
                        player.numCoin++;
                    break;
                }
            }
        ...
        if(Objects.equals(colorPawn.toString(), Game.m.get(3)))
            for(j = 0; j < 10; j++){
                if(position[3][j] != 1){
                    ...
                    numPink = j;
                    entrance.pinkPawn--;
                    if(Game.isExpert && (position[3][2] == 1 || position[3][5] == 1 || position[3][9] == 1))
                        player.numCoin++;
                    break;
                }
            }
        ...
        if(Objects.equals(colorPawn.toString(), Game.m.get(4)))  //metodo toString restituisce la rappresentazione di stringa delle costanti enum
            for(j = 0; j < 10; j++){
                if(position[4][j] != 1){
                    ...
                    numBlue = j;
                    entrance.bluePawn--;
                    if(Game.isExpert && (position[5][2] == 1 || position[5][5] == 1 || position[5][9] == 1))
                        player.numCoin++;
                    break;
                }
            }
